...
export default function Homepage() {
  ...
  return (
    <div className="min-h-screen bg-chill-background">
      ...
      {/* Hero Section */}
      <section className="relative h-[587px] flex flex-col justify-end">
        {/* Background Image */}
        <div
        ...
        {/* Content */}
        <div className="relative z-10 px-20 pb-20">
          <div className="max-w-4xl">
            {/* Title and Description */}
            <div className="mb-10">
              <h1 className="text-white text-5xl font-bold font-lato mb-5 leading-tight">
                Duty After School
              </h1>
              <p className="text-white text-lg font-medium font-lato max-w-2xl leading-relaxed">
            ...
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-2.5">
                {/* Primary Button */}
                <Button className="bg-chill-primary hover:bg-chill-primary/90 text-white px-7 py-2.5 rounded-full font-bold text-base font-lato">
                ...
                <Button 
                  variant="outline" 
                  className="bg-chill-paper hover:bg-chill-paper/80 border-none text-white px-7 py-2.5 rounded-full font-bold text-base font-lato"
                >
                ...
                <div className="px-2.5 py-2.5 border border-chill-secondary rounded-3xl">
                  <span className="text-chill-secondary text-lg font-lato">18+</span>
                </div>
              </div>

              {/* Volume Control */}
              <button className="p-2.5 border border-chill-secondary rounded-3xl hover:bg-white/10 transition-colors">
                <VolumeX className="w-6 h-6 text-chill-secondary" />
              </button>
            </div>
          </div>
        </div>
